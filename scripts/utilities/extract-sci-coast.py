...
## DATE: January 2025
## PURPOSE: Creates a shapefile of the SCI coastline for use in other analyses. 
...
out_fpath = root_dir / 'data' / '04_external' / 'sci-coastline' / 'sci-coastline.shp'
...
# Create NaturalEarthFeature for land
