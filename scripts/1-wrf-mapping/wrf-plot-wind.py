...
#-- Load WRF output.
path       =  '/Users/patmccornack/Documents/ucsb_fog_project/_repositories/sci-wrf-analysis/data/geospatial/wrf-vertical-profile/'
infile     =  'wrfout-2008-08-vertprofile.nc'
ncfile     =  nc.Dataset(path+infile)
...
#  savename  =  ''.join(['wrfout-wsp-', 'sb-', str(k).zfill(2), 'h', figtype ])  
  savepath  =  '/Users/patmccornack/Documents/ucsb_fog_project/_repositories/sci-wrf-analysis/outputs/spatial-analysis-figs/wrf-wind/'
